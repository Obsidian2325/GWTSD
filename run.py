...
# ADD
# Fliters
parser.add_argument('--select_filter',type=int, default=0, help='0 for Fourier and 1 for Wavelet')
parser.add_argument('--wavelet',type=str, default='db2', help='wavelet type')
parser.add_argument('--wavelet_level',type=int, default=1, help='wavelet decomposition level')


#GCN
parser.add_argument('--adj_path',type=str, default='Adj_Mat.csv', help='adj data file')
parser.add_argument('--gcn_dropout', type=float, default=0.5, help='GCN Dropout rate (1 - keep probability).')
parser.add_argument('--gcn_hidden_num', type=int, default=256,help='number of hidden units of GCN')
parser.add_argument('--gcn_alpha', type=float, default=0.5, help='GCN adj affect ratio.')

#difformer
parser.add_argument('--diff_hidden_channels', type=int, default=4, help='number of hidden units of difformer')
parser.add_argument('--diff_dropout', type=float, default=0.5, help='dropout of difformer')
parser.add_argument('--diff_num_heads', type=int, default=4, help='number of attention heads of difformer')

#mixup
parser.add_argument('--mixup_alpha', type=float, default=0.5, help='alpha for mixup gcn and difformer')
parser.add_argument('--hidden_num', type=int, default=256,help='number of hidden units of Mixup')
